...
- **战斗系统** - 回合制战斗，元素反应机制
- **数据持久化** - 本地存储游戏进度
- **笔记系统** - Markdown 剧情笔记、解锁触发与成就展示
- **世界观开场** - 开局打字机叙事 + 背景轮播
- **成就系统** - 结局成就 + 行为成就（采集/战斗/稳定剂）
- **赛博朋克风格** - 终端式 UI 设计
- **响应式布局** - 支持不同屏幕尺寸
...
- 剧情笔记由 `docs/scripts/*.md` 生成并在达成条件时弹出
- 成就分为行为类与结局类，达成后在笔记面板展示
